...
import { Search, Filter, FileText, List, LayoutGrid, Building, CreditCard, X, RefreshCw, User } from 'lucide-react';
...
import { fetchInvoiceHeaders, fetchInvoiceDetail } from '@/lib/api';
        ...
        <div className="flex-1 overflow-auto">
          ...
          <div className="px-8 py-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 hover:shadow-2xl transition-all duration-300">
                <div className="text-center">
                  <div className="p-4 rounded-2xl bg-gradient-to-br from-gray-700 to-gray-800 w-fit mx-auto mb-4">
